...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Supported(ADVENTURER)= " + PlayerFactory.isSupported(AvatarClass.ADVENTURER.name()));
        ...
        System.out.println("Du coup, PIT a moins de mutations pertinentes et davantage de mutants équivalents :");
